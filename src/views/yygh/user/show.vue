    ...
    <div class="app-container">
        ...
        <tbody>
            <tr>
                ...
                <th width="15%">用户姓名</th>
                <td width="35%">{{ userInfo.nickName }}</td>
            </tr>
        <tr>
            <th>状态</th>
...
export default {
    ...
    data() {
        return {
            id: this.$route.params.id, //path/1
            userInfo: {}, // 会员信息
            patientList: [] // 就诊人列表
        }
    },
    ...
    methods: {
        ...
        fetchDataById() {
            userInfoApi.show(this.id).then(response => {
                this.userInfo = response.data.userInfo //根据id查询的用户
                this.patientList = response.data.patientList//当前用户的就诊人列表
            })
        },
        back() {
